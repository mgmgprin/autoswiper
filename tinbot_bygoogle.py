...
# 【概要】
# google経由でのログイン
# スワイプの自動化：スワイプ回数の指定、距離、無制限の除外ワード、プロフ無記載などの条件に応じて左スワイプ可能
# 広告ポップアップの無効化に対応
# メッセージの自動送信、1人に対して無制限にテンプレメッセージを送信可能
# 曜日によってメッセージ内容を変更可能
# 1週目のみ日曜日までに返信が来ていなかったユーザーに対してリマインド送信が可能

# 【注意事項】
# 本スクリプトの使用によるアカウントの停止などが生じた場合について一切責任を負いません
# サイトの刷新などにより正常に動作しなくなる可能性があります
